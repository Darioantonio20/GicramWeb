...
export const ConstructionIcon: React.FC<IconProps> = ({ className = '', size = 'md' }) => {
  const sizeClasses = {
    sm: 'w-4 h-4',
    md: 'w-6 h-6',
    lg: 'w-8 h-8',
...
export const EmailIcon: React.FC<IconProps> = ({ className = '', size = 'md' }) => {
  const sizeClasses = {
    sm: 'w-4 h-4',
    md: 'w-6 h-6',
    lg: 'w-8 h-8',
...
export const WrenchIcon: React.FC<IconProps> = ({ className = '', size = 'md' }) => {
  const sizeClasses = {
    sm: 'w-4 h-4',
    md: 'w-6 h-6',
    lg: 'w-8 h-8',
...
// Iconos para reemplazar emojis
export const TimeIcon: React.FC<IconProps> = ({ className = '', size = 'md' }) => {
  const sizeClasses = {
    sm: 'w-4 h-4',
    md: 'w-6 h-6',
    lg: 'w-8 h-8',
...
export const TrophyIcon: React.FC<IconProps> = ({ className = '', size = 'md' }) => {
  ...
  return (
    <svg className={`${sizeClasses[size]} ${className}`} fill="currentColor" viewBox="0 0 24 24">
      <path d="M7 4V2C7 1.45 7.45 1 8 1H16C16.55 1 17 1.45 17 2V4H20C20.55 4 21 4.45 21 5V7C21 9.66 19.66 11 17 11H15C15 12.1 14.1 13 13 13H11C9.9 13 9 12.1 9 11H7C4.34 11 3 9.66 3 7V5C3 4.45 3.45 4 4 4H7ZM5 7C5 8.1 5.9 9 7 9H9V11C9 13.21 10.79 15 13 15H15C17.21 15 19 13.21 19 11V9H21C22.1 9 23 8.1 23 7V5C23 3.9 22.1 3 21 3H19V1C19 0.45 18.55 0 18 0H6C5.45 0 5 0.45 5 1V3H3C1.9 3 1 3.9 1 5V7C1 8.1 1.9 9 3 9H5V7Z"/>
    </svg>
  );
};
