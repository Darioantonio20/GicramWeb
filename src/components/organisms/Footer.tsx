      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <Text variant="h3" color="yellow" className="mb-4 font-bold">
              GICRAM
            </Text>
            <Text variant="body" color="white" className="mb-6 opacity-80">
          ...
          {/* Services */}
          <div>
            <Text variant="h4" color="white" className="mb-4">
              Servicios
            </Text>
